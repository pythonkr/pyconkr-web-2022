...
class Proposal(models.Model):
    ...
    video_url = models.CharField(max_length=255, null=True, blank=True, help_text='발표 영상 URL')
    slide_url = models.CharField(max_length=255, null=True, blank=True, help_text='발표 자료 URL')
    video_open_at = models.DateTimeField(null=True, blank=True, help_text='파이콘 한국 유튜브에 공개되는 시간')
