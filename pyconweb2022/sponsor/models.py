...
class Sponsor(models.Model):
    ...
    manager_name = models.CharField(max_length=100, help_text=(
        '준비위원회와 후원과 관련된 논의를 진행할 담당자의 이름을 입력해주십시오.'))
    manager_email = models.CharField(
        max_length=100, help_text=('입력하신 메일로 후원과 관련된 안내 메일이나 문의를 보낼 예정입니다. 후원 담당자의 이메일 주소를 입력해주십시오.'))
    manager_id = models.ForeignKey(User, null=True, blank=True, on_delete=models.CASCADE, help_text=('후원사를 위한 추가 아이디'),
